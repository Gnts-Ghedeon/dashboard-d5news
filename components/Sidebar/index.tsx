  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-3">
        <Link href="/">
          ...
          {/* <div className="flex items-center gap-2">
            <div className="h-10 w-10 bg-danger"></div>
            <span className="text-3xl text-white font-bold">D5 Admin</span>
          </div> */}
        </Link>
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        {/* <!-- Sidebar Menu --> */}
        <nav className="mt-5 py-4 px-4 lg:mt-0 lg:-px-4">
          {/* <!-- Menu Group --> */}
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          {/* <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/posts/categories" && "text-white"
                              } `}
                            >
                              Catégories
                            </Link>
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              href="/podcasts/add"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/podcasts/add" && "text-white"
                              } `}
                            >
                              Ajouter un podcast
                            </Link>
                          ...
                          {/* <li>
                            <Link
                              href="/podcasts/categories"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/podcasts/categories" && "text-white"
                              } `}
                            >
                              Catégories
                            </Link>
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              href="/videos/add"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/videos/add" && "text-white"
                              } `}
                            >
                              Ajouter un post vidéo
                            </Link>
                          </li>
                        </ul>
                      </div>
              ...
              {/* <li>
                ...
                >
                  ...
                  >
                    <path d="M1662.178 0v1359.964h-648.703l-560.154 560.154v-560.154H0V0h1662.178ZM1511.07 151.107H151.107v1057.75h453.321v346.488l346.489-346.488h560.154V151.107ZM906.794 755.55v117.53H453.32V755.55h453.473Zm302.063-302.365v117.529H453.32V453.185h755.536Z" fillRule="evenodd"/>
                  </svg>
                  Commentaires
                  <span
                    className={`z-1 h-2 w-2 rounded-full bg-meta-1`}
                  >
                    <span className="absolute -z-1 inline-flex h-2 w-2 animate-ping rounded-full bg-meta-1 opacity-75"></span>
                  </span>
                </Link>
              </li> */}
              {/* <!-- Menu Item Comments --> */}
                    ...
                    <React.Fragment>
                      ...
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" className=""
                          ...
                          <path d="M10.1992 12C12.9606 12 15.1992 9.76142 15.1992 7C15.1992 4.23858 12.9606 2 10.1992 2C7.43779 2 5.19922 4.23858 5.19922 7C5.19922 9.76142 7.43779 12 10.1992 12Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                          <path d="M1 22C1.57038 20.0332 2.74795 18.2971 4.36438 17.0399C5.98081 15.7827 7.95335 15.0687 10 15C14.12 15 17.63 17.91 19 22" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                          <path d="M17.8205 4.44006C18.5822 4.83059 19.1986 5.45518 19.579 6.22205C19.9594 6.98891 20.0838 7.85753 19.9338 8.70032C19.7838 9.5431 19.3674 10.3155 18.7458 10.9041C18.1243 11.4926 17.3302 11.8662 16.4805 11.97" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                          <path d="M17.3203 14.5701C18.6543 14.91 19.8779 15.5883 20.8729 16.5396C21.868 17.4908 22.6007 18.6827 23.0003 20" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                        Utilisateurs
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${
