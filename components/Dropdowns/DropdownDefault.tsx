  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        className={`absolute right-0 top-full z-40 w-40 space-y-1 rounded-lg border border-stroke bg-white py-6 px-7.5 shadow-default p-1.5 shadow-default dark:border-strokedark dark:bg-boxdark ${
